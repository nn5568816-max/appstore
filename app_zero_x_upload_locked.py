...
def init_db():
    ...
    if not existing_admin and admin_password:
        conn.execute(
            ...
            (
                os.environ.get("ADMIN_FIRST_NAME", "Zero"),
                os.environ.get("ADMIN_LAST_NAME", "X"),
                os.environ.get("ADMIN_USERNAME", "zerox"),
...
<div class="modal" id="adminModal">
  <div class="modal-card" style="text-align:center;">
    <div class="logo-box" style="margin:0 auto 14px;width:72px;height:72px;font-size:30px;">ZX</div>
